...
// Set FRONTEND_URL in your .env file as a comma-separated list of allowed origins
...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    // In development mode, allow any origin. In production, check against whitelist.
    if (
